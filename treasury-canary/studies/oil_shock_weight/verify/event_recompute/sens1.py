...
def classify(on, events, h, win_start, win_end_onset, series_start, doubledip=True, kind='nber'):
    ...
    for ep in eps:
        ...
        for e in evs:
            ...
            lo,hi = (free[0] if free else raw_first), (free[-1] if free else raw_last)+h
...
json.dump(out,open('/tmp/claude-0/-home-user-uranium-dashboard/2a5ba7c6-de7e-5470-a27d-d0386eb4bbf1/scratchpad/oil/verify/event_recompute/mine_sens_usrec0_window.json','w'),indent=1,default=str)
print('written')

...
def episodes(on):
    ...
    on=on & (usrec.reindex(on.index).fillna(1)==0)
...
json.dump(out,open('/tmp/claude-0/-home-user-uranium-dashboard/2a5ba7c6-de7e-5470-a27d-d0386eb4bbf1/scratchpad/oil/verify/event_recompute/mine_sens_strict.json','w'),indent=1,default=str)
print('written')

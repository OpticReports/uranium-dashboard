...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  accident_gauge: {
    ...
    caveat: "A high-conviction tripwire, not a net: it missed 2018 (curve stayed steep) and 2021 (policy-driven grind, the slow channels' domain), and a sibling rule (oil/policy window + flat curve) now scores higher. Both conditions and the +0.25pp threshold come from the study's pre-specified design (studies/pin-rule-hindcast v2) — nothing is fitted, ~11 clusters is a small sample, and 34% is descriptive history, not a calibrated probability. The sibling rule (oil/policy window + flat curve) now scores higher, 45% on 5 of 6 clusters — treat the pair as one family.",
  },
  pin_board: {

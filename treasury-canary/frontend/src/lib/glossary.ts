...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  fast_leverage: {
    ...
    caveat: "Weekly observations overlap heavily — episode counts (3/22/16/23) are the honest sample sizes, and FLUSH's stats rest on 3 episodes. These are mean-reversion signals at weeks-to-months horizons, NOT cycle calls: 2008 started from CALM. BTC funding/OI and HY spreads are display legs with no backtested stats (FRED now caps ICE BofA spread history at ~3y — too short to backtest honestly). Deribit OI history accrues from first deploy — the sparkline starts short and grows.",
  },
